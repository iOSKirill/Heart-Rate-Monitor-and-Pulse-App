...
internal enum Asset {
  ...
  internal enum Colors {
    ...
    internal static let appBlueAlice = ColorAsset(name: "AppBlueAlice")
  ...
  internal enum Images {
    ...
    internal static let historyHRVIcon = ImageAsset(name: "HistoryHRVIcon")
    ...
    internal static let historyPulseIcon = ImageAsset(name: "HistoryPulseIcon")
    internal static let historyShareIcon = ImageAsset(name: "HistoryShareIcon")
