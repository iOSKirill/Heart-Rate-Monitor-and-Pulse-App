...
internal enum Asset {
  ...
  internal enum Colors {
    ...
    internal static let progressBarRed = ColorAsset(name: "ProgressBarRed")
    internal static let redGradientFirstButton = ColorAsset(name: "RedGradientFirstButton")
    internal static let redGradientSecondButton = ColorAsset(name: "RedGradientSecondButton")
    internal static let settingsButtonBackground = ColorAsset(name: "SettingsButtonBackground")
    internal static let shadowButton = ColorAsset(name: "ShadowButton")
